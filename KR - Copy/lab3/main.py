...
class Graph:  # graful problemei
    def __init__(self, nume_fisier):
        ...
        def obtineStive(sir):
            ...
            # in Python: val_true if cond else val_false
    ...
    def testeaza_scop(self, nodCurent):
        # lenOk = True
        # lungime = len(nodCurent.info[0])
        # for lista in nodCurent.info:
        #     if lungime != len(lista):
        #         lenOk = False
        #         break


        # return (nodCurent.info in self.scopuri) or lenOk;
    ...
    def calculeaza_h(self, infoNod, tip_euristica="euristica banala"):
        if tip_euristica == "euristica banala":
            ...
            #calculez euristica pt stive egale
            # le = 0
            # ls = len(infoNod)
...
nrSolutiiCautate = 3
a_star(gr, nrSolutiiCautate=6, tip_euristica="euristica neadmisibila")
